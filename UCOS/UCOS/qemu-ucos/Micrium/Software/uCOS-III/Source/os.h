...
#if (OS_CFG_TASK_IDLE_EN > 0u)
extern  CPU_STK        OSCfg_IdleTaskStk[OS_CFG_IDLE_TASK_STK_SIZE + 32];
#endif

#if (OS_CFG_ISR_STK_SIZE > 0u)
extern  CPU_STK        OSCfg_ISRStk[OS_CFG_ISR_STK_SIZE + 32];
#endif
...
#if (OS_CFG_STAT_TASK_EN > 0u)
extern  CPU_STK        OSCfg_StatTaskStk[OS_CFG_STAT_TASK_STK_SIZE + 32];
#endif

#if (OS_CFG_TMR_EN > 0u)
extern  CPU_STK        OSCfg_TmrTaskStk[OS_CFG_TMR_TASK_STK_SIZE + 32];
#endif
...
#define ENABLE_STATIC_FUN_TEST  1u

#if(ENABLE_STATIC_FUN_TEST == 1u)
typedef  void  (*OS_STATIC_PTR_TYPE_A)(void );
typedef  void  (*OS_STATIC_PTR_TYPE_B)(OS_TICK  timeout);
extern OS_STATIC_PTR_TYPE_A ptr_OS_TmrLock;
extern OS_STATIC_PTR_TYPE_A ptr_OS_TmrUnlock;
extern OS_STATIC_PTR_TYPE_A ptr_OS_TmrCondCreate;
extern OS_STATIC_PTR_TYPE_B ptr_OS_TmrCondWait;
extern OS_STATIC_PTR_TYPE_A ptr_OS_TmrCondSignal;
extern OS_STATIC_PTR_TYPE_B ptr_OS_TickListUpdate;
#endif
