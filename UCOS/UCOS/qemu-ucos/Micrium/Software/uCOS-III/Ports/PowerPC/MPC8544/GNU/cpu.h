...
#define  CPU_NOP()          __asm("xori 0,0,0");


/*
void        CPU_DEC_Set   (CPU_INT32U     val);
void        CPU_DECAR_Set (CPU_INT32U     val);
CPU_INT32U  CPU_HID0_Get  (void);
void        CPU_HID0_Set  (CPU_INT32U     val);
CPU_INT32U  CPU_TBL_Get   (void);
CPU_INT32U  CPU_TBU_Get   (void);
void        CPU_TBL_Set   (CPU_INT32U     val);
void        CPU_TBU_Set   (CPU_INT32U     val);
CPU_INT32U  CPU_TCR_Get   (void);
void        CPU_TCR_Set   (CPU_INT32U     val);

void        CPU_IVOR0_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR1_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR2_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR3_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR4_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR5_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR6_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR7_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR8_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR9_Set (CPU_FNCT_VOID  fnct);
void        CPU_IVOR10_Set(CPU_FNCT_VOID  fnct);
void        CPU_IVOR11_Set(CPU_FNCT_VOID  fnct);
void        CPU_IVOR12_Set(CPU_FNCT_VOID  fnct);
void        CPU_IVOR13_Set(CPU_FNCT_VOID  fnct);
void        CPU_IVOR14_Set(CPU_FNCT_VOID  fnct);
void        CPU_IVOR15_Set(CPU_FNCT_VOID  fnct);
void        CPU_IVOR32_Set(CPU_FNCT_VOID  fnct);
void        CPU_IVOR33_Set(CPU_FNCT_VOID  fnct);
void        CPU_IVOR34_Set(CPU_FNCT_VOID  fnct);
*/
